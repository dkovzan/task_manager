	...
	<div class="card">
		<div class="page-header">
			...
			<button class="btn btn-add"
					onclick="location.href='${pageContext.request.contextPath}controller?command=${Commands.PRINT_EDIT_EMPLOYEE}&${UtilParams.IS_ADD_FORM}=true'">
				Add
				employee
			</button>
		</div>
					...
					<table class="content-table">
						...
						<c:forEach items="${employees}" var="employee">
							<tr>
								...
								<td>
									<button onclick="location.href='${pageContext.request.contextPath}controller?command=${Commands.PRINT_EDIT_EMPLOYEE}&${EmployeeParams.EMPLOYEE_ID}=${employee.id}&${UtilParams.IS_ADD_FORM}=0'"
											class="btn btn-edit">Edit
									</button>
								</td>
								<td>
									<button onclick="location.href='${pageContext.request.contextPath}controller?command=${Commands.REMOVE_EMPLOYEE}&${EmployeeParams.EMPLOYEE_ID}=${employee.id}'"
