...
public class ParameterNameConstant {
	...
	public static final String PROJECT_SHORTNAME = "project_shortName";
	...
	public static final String TASK_INVALID_DATE_RANGE = "task_invalid_date_range";
	public static final String VALUE_INVALID_DATE_RANGE = "Begin date cannot be later then end date.";
	...
	public static final String PRINTED_EMPLOYEES = "printed_employees";
	public static final String PRINTED_EDIT_EMPLOYEE = "printed_edit_employee";
