...
<body class="w3-light-grey">
	...
	<div class="w3-container w3-center w3-margin-bottom w3-padding">
		<div class="w3-card-4">
			...
			<c:choose>
				<c:when
					test="${requestScope.get(ParameterNameConstant.PRINTED_PROJECTS) != null && !requestScope.get(ParameterNameConstant.PRINTED_PROJECTS).isEmpty()}">
					<table class="w3-table w3-bordered w3-border">
						...
						<c:forEach
							...
							var="project">
							<tr>
								<input type="hidden" name="${ParameterNameConstant.PROJECT_ID}"
									value="${project.id}">
								<td>${project.id}</td>
								<td>${project.name}</td>
